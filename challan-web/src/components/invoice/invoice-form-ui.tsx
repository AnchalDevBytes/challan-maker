...
export function InvoiceFormUI({
  ...
  return (
    <Card className="w-full sm:bg-white sm:shadow-sm sm:border-neutral-200 overflow-hidden">
      <div className="p-2 sm:p-10 space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div>
                ...
                {errors.senderDetails?.name && (
                  <span className="text-[10px] text-red-500 font-medium">
                    {errors.senderDetails.name.message}
                  </span>
                )}
              </div>
              <Textarea
              ...
              <div className="min-w-[480px]">
                ...
                <div className="divide-y divide-neutral-100">
                  {fields.map((field, index) => (
                    <div
                      key={field.id}
                      className="grid grid-cols-12 px-4 py-3 items-center gap-2 hover:bg-neutral-50/50"
                    >
                        ...
                        <Input
                          ...
                          className={cn(
                            ...
                            errors.items?.[index]?.description &&
                              "border-red-300 focus-visible:ring-red-300 bg-red-50",
                          )}
                        />
                      </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-4">
          ...
          <div className="flex-1 space-y-2">
            ...
            <Textarea
              {...register("terms")}
              className="h-20 resize-none bg-neutral-50/50"
            />
          </div>
        </div>
      </div>
