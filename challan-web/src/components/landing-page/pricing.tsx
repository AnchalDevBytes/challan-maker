            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto items-stretch">
                ...
                >
                    ...
                    <Link href="/guest" className="mt-10">
                        <Button variant="outline" className="w-full h-14 rounded-2xl border-neutral-200 text-base font-medium hover:bg-neutral-50 transition-all cursor-pointer">
                            Start for Free
                        </Button>
                    </Link>
                </motion.div>
                ...
                >
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-neutral-500 text-sm">The ultimate tool for scaling.</p>
                    </div>

                    <div className="space-y-6 grow">
                        <div className="flex items-baseline gap-1">
                            <span className="text-3xl font-medium text-green-600">₹100</span>
                    ...
                    <div className="mt-10 relative">
                        <Button disabled className="w-full h-14 rounded-2xl bg-neutral-100 text-neutral-400 border-none text-lg font-bold cursor-not-allowed">
                            Coming Soon
                        </Button>
...
const FeatureItem = ({ text, active = false, muted = false, lg = false }: { text: string; active?: boolean; muted?: boolean; lg?: boolean }) => (
  <li className={cn(
    ...
    <span className={cn(lg ? "text-base font-semibold" : "text-sm font-medium")}>{text}</span>
  </li>
);
