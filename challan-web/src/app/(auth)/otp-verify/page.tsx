    ...
    <div className="min-h-screen w-full bg-neutral-50 flex items-center justify-center p-4">
        <div className="w-full max-w-100 bg-white rounded-xl shadow-lg border border-neutral-200 overflow-hidden">
            ...
            <div className="flex items-center gap-2 mt-2 mb-8">
                ...
                <button 
                    className="text-blue hover:opacity-80 transition"
                >
                    <Pencil size={18}/>
                </button>
            </div>
            ...
            <div className="mb-8 text-center">
             {timer > 0 ? (
                <p className="text-sm text-neutral-500">
                    Resend code in <span className="font-medium text-neutral-900">{formatTime(timer)}</span>
                </p>
             ) : (
                <button
            ...
            >
                {isSubmitting ? <Loader2 className="animate-spin" /> : "Verify & Signup"}
            </button>
